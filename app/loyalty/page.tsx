...
import HeroMarquee from "../../components/loyalty/HeroMarquee";
import SectorsMarquee from "../../components/loyalty/SectorsMarquee";

export const metadata: Metadata = {
  title: "Checky Loyalty — Estampilleros de lealtad digitales",
  description:
    "Estampilleros de lealtad digitales que hacen que tus clientes vuelvan. Sin cartones, sin apps. Directo en Apple Wallet y Google Wallet.",
};
...
const howImages = {
  step1: {
    src: "https://www.coupontools.com/assets/images/loyalty/loyaltycard-mockup-stamp.webp",
    alt: "Personalización del Checky",
  },
  step2: {
    src: "https://media.istockphoto.com/id/2193788051/es/foto/primer-plano-de-una-mujer-que-realiza-un-pago-m%C3%B3vil-escaneando-un-c%C3%B3digo-qr.webp?a=1&b=1&s=612x612&w=0&k=20&c=HNJOggbj8oqzn8E77of2dsEMqOBmawkRiX-p3VWYiAc=",
    alt: "QR para guardar el Checky",
  },
  step3: {
    src: "https://www.puntosparati.com/images/hero-sistema-puntos-5.webp",
    alt: "Estadísticas / crecimiento",
  },
};
      ...
      <main className="bg-checky-bg text-checky-text">
        ...
        <section className="mx-auto max-w-6xl px-4 py-14 md:py-20">
          <div className="max-w-3xl">
            ...
            <div className="mb-3 inline-flex items-center gap-2">
              <span className="inline-flex items-center rounded-full border border-checky-green/30 bg-checky-green/10 px-3 py-1 text-xs font-semibold text-checky-green">
                Checky Loyalty
              </span>
            </div>
            ...
            <h1 className="mt-4 text-4xl font-bold leading-tight md:text-5xl">
              ...
              <br />
              Necesitas que los mismos{" "}
              <span className="text-checky-green">vuelvan</span>.
            </h1>
            ...
            <p className="mt-4 text-lg text-checky-muted">
              En cada visita el cliente se siente reconocido, recompensado y
              querido… y cuando eso pasa,{" "}
              <span className="font-bold text-checky-green">vuelven</span>.
            </p>
            ...
            <div className="mt-8 grid gap-6 md:grid-cols-3">
              <div className="rounded-3xl border border-checky-border bg-checky-bg p-6">
                ...
                <p className="mt-3 text-checky-muted">
                  Personalizamos tu estampillero con tu marca, colores,
                  logotipos y reglas de recompensa a tu gusto.
                </p>
                <div className="relative mt-5 aspect-[4/3] w-full overflow-hidden rounded-2xl border border-checky-border bg-white">
                  <Image
                    src={howImages.step1.src}
                    alt={howImages.step1.alt}
                    fill
              ...
              <div className="rounded-3xl border border-checky-border bg-checky-bg p-6">
                ...
                <p className="mt-3 text-checky-muted">
                  Tus clientes guardan el estampillero en Apple Wallet o Google
                  Wallet por medio de un QR en cuestión de segundos.
                </p>
                <div className="relative mt-5 aspect-[4/3] w-full overflow-hidden rounded-2xl border border-checky-border bg-white">
                  <Image
                    src={howImages.step2.src}
                    alt={howImages.step2.alt}
                    fill
                    className="object-cover"
                  />
                </div>
              ...
              <div className="rounded-3xl border border-checky-border bg-checky-bg p-6">
                ...
                <p className="mt-3 text-checky-muted">
                  Mide el impacto en tu negocio. Descubre cómo crece la lealtad
                  de tus clientes y aumentan tus ingresos con cada visita.
                </p>
                <div className="relative mt-5 aspect-[4/3] w-full overflow-hidden rounded-2xl border border-checky-border bg-white">
                  <Image
                    src={howImages.step3.src}
                    alt={howImages.step3.alt}
                    fill
                    className="object-cover"
                  />
                </div>
          ...
          <div className="grid gap-10 lg:grid-cols-2 lg:items-center">
            <div>
              ...
              <ul className="mt-8 space-y-5">
                {[
                  ["Todo es digital", "No se necesitan cartones. Ya no se pierden: todo se guarda en el teléfono."],
                  ["Notificaciones geolocalizadas", "Atrae más clientes justo cuando están a 1 km o menos de tu sucursal."],
                  ["Fidelizas a tus clientes", "Premias la constancia y haces que quieran volver más seguido."],
                  ["Consientes a tus clientes", "Cada visita se siente como un gesto de cuidado, no como un trámite."],
                  ["Fácil de gestionar", "Reglas claras, control simple y experiencia rápida para el cliente."],
                  ["Estadísticas", "Mide el impacto: visitas, recurrencia y comportamiento."],
                ].map(([t, d]) => (
        ...
        <section id="planes" className="bg-white">
          <div className="mx-auto max-w-6xl px-4 py-14">
            ...
            <p className="mt-2 text-checky-muted">Elige el plan perfecto para ti.</p>
                  ...
                  <div className="flex items-start justify-between gap-4">
                    <div>
                      <p
                        className={
                          p.highlighted
                            ? "text-sm font-semibold text-checky-green"
                            : "text-sm font-semibold text-checky-muted"
                        }
                      >
                        {p.name}
                      </p>
                      <p className="mt-2 text-4xl font-bold">
                        ${p.price}{" "}
                        <span className="text-base font-semibold text-checky-muted">
                          MXN
                        </span>
                      </p>
