...
function Tile({ s }: { s: Sector }) {
  return (
    <div className="group relative h-[160px] w-[260px] shrink-0 overflow-hidden rounded-3xl border border-checky-border bg-checky-bg shadow-sm md:h-[180px] md:w-[300px]">
      <Image
        src={s.img}
        alt={s.name}
        fill
